...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:ListBox ID="lstDiscountList" runat="server" Height="300px" Width="500px"></asp:ListBox>
        </div>
        <p>
...
<asp:Label ID="lblError" runat="server" style="z-index: 1; left: 17px; top: 584px; position: absolute"></asp:Label>
<asp:Label ID="lblFilterCode" runat="server" style="z-index: 1; left: 17px; top: 449px; position: absolute" Text="Enter a Discount Code"></asp:Label>
<asp:TextBox ID="txtFilterCode" runat="server" style="z-index: 1; left: 225px; top: 443px; position: absolute; height: 28px; width: 175px"></asp:TextBox>
