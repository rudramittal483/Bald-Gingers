<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddressConfirmDelete.aspx.cs" Inherits="AddressConfirmDelete" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Address Confirm Delete</title>
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5">
                <div class="card shadow border-danger rounded-3">
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <asp:Label ID="lblConfirm" runat="server" CssClass="fs-5 fw-semibold mb-4 d-block" Text="Are you sure you want to delete this Address"></asp:Label>
